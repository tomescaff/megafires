...
# compute clim
da = cr2.sel(time=slice('1979-01-01', '2018-12-31')).std('time').squeeze()
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap='jet', zorder=4, vmin=0, vmax=2)
...
plt.savefig('../../../megafires_data/png/CR2MET_1979_2018_std_full.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()