...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred, zorder=4, vmin=-1, vmax=1)
...
plt.savefig('../../../megafires_data/png/CR2MET_QN_corr_full.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()