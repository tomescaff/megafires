...
# compute clim
da = cr2.sel(time=slice('1979-01-01', '2018-12-31')).mean('time').squeeze()
...
pcm = ax.pcolormesh(da.lon.values, da.lat.values, da.values, cmap=cmaps.amwg_blueyellowred, zorder=4, vmin=10, vmax=30)
...
plt.savefig('../../../megafires_data/png/CR2MET_1979_2018_clim_full.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()