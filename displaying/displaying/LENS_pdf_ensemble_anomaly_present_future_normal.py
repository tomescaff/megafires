...
plt.plot(x, norm.pdf(x, *normfit_lensa_1990_2020), 'b', linewidth=2, label = 'LENSA (40 runs) 1990-2020')
...
plt.ylabel('PDF')
plt.savefig('../../../megafires_data/png/LENS_pdf_ensemble_anomaly_present_future_normal.png', dpi=300)
plt.show()
