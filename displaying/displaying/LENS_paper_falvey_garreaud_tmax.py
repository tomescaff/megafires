...
ds = xr.open_dataset('../../../megafires_data/LENS_ALL/LENS_tmax_1979_2006_yearly_trend.nc')
slope = ds['slope'].median('run')*10
...
cbar.ax.set_title('Maximum Temperature Trend 1979-2006 (ºC/dec) ', fontdict={'fontsize':10})

plt.savefig('../../../megafires_data/png/LENS_paper_falvey_garreaud_tmax.png', dpi=300)
plt.show()
