...
plt.bar(center, hist_lens, align='center', width=width, edgecolor='k', facecolor='b', color='blue', alpha = 0.25, label='LENS 1920-1950')
...
plt.title(f'LENS (all runs) 1920-1950 vs. control run (KS test: p={p:.2f})')
plt.savefig('../../../megafires_data/png/LENS_distribution_all_runs_control_run_1920_1950.png', dpi=300)
plt.show()