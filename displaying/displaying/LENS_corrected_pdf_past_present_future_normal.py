...
plt.axvline(temp_ee, color='k', linewidth=1.2, label = 'Temp EE')
plt.axvline(qn.sel(time='2017'), color='grey', linewidth=1.2, label = 'Temp 2017 QN')
...
plt.ylabel('PDF')
plt.savefig('../../../megafires_data/png/LENS_corrected_pdf_past_present_future_normal.png', dpi=300)
plt.show()
