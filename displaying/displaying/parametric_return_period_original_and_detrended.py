...
plt.title('January Tmax return period at Quinta Normal (COUNTERFACTUAL as detrended)')
plt.savefig('../../../megafires_data/png/QN_parametric_return_period_original_and_detrended.png', dpi=300)
plt.show()
