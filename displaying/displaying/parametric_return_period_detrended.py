...
plt.axhline(u.max(), lw=1, color='grey', ls='-.', label='Jan 2017 value (detrended)')
...
plt.title('January Tmax return period at Quinta Normal (detrended)')
plt.savefig('../../../megafires_data/png/QN_parametric_return_period_detrended.png', dpi=300)
plt.show()
