...
qn_shift_2017 = qn - mu + mu_2017
qn_shift_1880 = qn - mu + mu_1880

u_shift_2017, tau_shift_2017 = ut.get_tau(qn_shift_2017.values)
...
plt.axhline(qnf.sel(time='2017'), color='fuchsia', lw=1.2, label='Observed 2017')
...
plt.savefig('../../../megafires_data/png/QN_MLE_tasmax_return_period_fit_1930_2021.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()