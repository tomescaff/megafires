...
ds = xr.open_dataset('../../../megafires_data/LENS_ALL/LENS_tmean_1979_2006_yearly_trend.nc')
...
plt.savefig('../../../megafires_data/png/LENS_paper_falvey_garreaud_tmean.png', dpi=300)
plt.show()
