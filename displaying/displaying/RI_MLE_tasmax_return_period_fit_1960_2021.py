...
xopt = pmath.mle_norm_2d(ri.values, sm.values, [15, 2, 0.5])
...
ri_shift_2017 = ri - mu + mu_2017
ri_shift_1880 = ri - mu + mu_1880

u_shift_2017, tau_shift_2017 = ut.get_tau(ri_shift_2017.values)
u_shift_1880, tau_shift_1880 = ut.get_tau(ri_shift_1880.values)
...
plt.axhline(rif.sel(time='2017'), color='fuchsia', lw=1.2, label='Observed 2017')
...
plt.savefig('../../../megafires_data/png/RI_MLE_tasmax_return_period_fit_1960_2021.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()