...
plt.plot(da.time.values, dtrend['y_pred'], lw = 2.5, alpha=0.7, color='red', label='Linear trend ({:.1f} ºC/dec)'.format(dtrend['b']*10))
...
plt.savefig('../../../megafires_data/png/QN_time_series_with_trend.png', dpi=300)
plt.show()
