...
plt.plot(x, norm.pdf(x, *normfit_cr), 'b', linewidth=2, label = 'LENS Control Run')
plt.plot(x, norm.pdf(x, *normfit_ar_1920_1950), 'b', linewidth=1.2, ls='--',label = 'LENS (40 runs) 1920-1950')
...
plt.ylabel('PDF')
plt.savefig('../../../megafires_data/png/LENS_pdf_control_run_present_future_normal.png', dpi=300)
plt.show()
