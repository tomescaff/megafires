...
plt.xlim([1920, 2100])
plt.legend()
plt.savefig('../../../megafires_data/png/LENS_bias_correction_maxmin_QNE.png', dpi=300)
plt.show()
...
plt.xlim([1920, 2100])
plt.legend()
plt.savefig('../../../megafires_data/png/LENS_bias_correction_all_runs_QNE.png', dpi=300)
plt.show()
