...
plt.scatter(sm, cu, s=12, marker='o', edgecolor='blue', facecolor='none')
plt.scatter(smf.sel(time='2017'), cuf.sel(time='2017'), s=12, marker='s', edgecolor='fuchsia', facecolor='none')
...
plt.savefig('../../../megafires_data/png/CU_MLE_tasmax_GMST_scatter_fit_1960_2021.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()