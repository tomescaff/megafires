...
# get LENS2 tmax
ds = xr.open_dataset('../../../megafires_data/LENS2/LENS2_tmax_1979_2006_yearly_trend.nc')

# compute the climatology
data = ds['slope'].median('run')*10
...
pcm = ax.pcolormesh(data.lon.values, data.lat.values, data.values, cmap='jet', alpha=0.8, zorder=3, vmin=-0.25, vmax=0.25)
