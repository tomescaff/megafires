...
da = 41-ut.get_CR2MET_2017_ranking()
...
pcm = ax.contourf(da.lon.values, da.lat.values, da.values, cmap='jet_r', zorder=4, levels=[0,1,3,5,7,10, 15, 20, 25, 30, 35, 40])
...
plt.savefig('../../../megafires_data/png/CR2MET_jan_2017_tmax_ranking.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()