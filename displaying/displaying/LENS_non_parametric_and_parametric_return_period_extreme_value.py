...
# computing y values
y_norm_ar_1950_2021 = genextreme.isf(1/x, *gevfit_ar_1950_2021)
y_norm_cr = genextreme.isf(1/x, *gevfit_cr)
...
plt.plot(x, y_norm_ar_1950_2021, color='b', lw=1.5, alpha = 1, label = 'Parametric return period (GEV) ACTUAL ', zorder=4)
plt.plot(x, y_norm_cr, color='r', lw=1.5, alpha = 1, ls='--', label = 'Parametric return period (GEV) CONTRAFACTUAL', zorder=4)
...
plt.savefig('../../../megafires_data/png/LENS_non_parametric_and_parametric_return_period_extreme_value.png', dpi=300)
plt.show()