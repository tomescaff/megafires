...
tau = 1/norm.sf(np.median(lens_ev), *normfit_ar_1950_2021)
cr_ev = norm.isf(1/tau, *normfit_cr)
...
plt.savefig('../../../megafires_data/png/LENS_return_period_normal_with_fraction.png', dpi=300)
plt.show()