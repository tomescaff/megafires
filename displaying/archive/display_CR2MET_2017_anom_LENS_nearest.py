...
circle = plt.Circle((-70.6828, -33.4450), 0.5, color='b', fill=False, zorder=4, lw=0.5, label='Quinta Normal')
ax.add_patch(circle)
...
circle = plt.Circle((da.lon-360, da.lat), 0.5, color='r', fill=False, zorder=5, lw=0.5, label='LENS nearest point')
ax.add_patch(circle)
...
plt.savefig('../../../megafires_data/png/CR2MET_jan_2017_anom_LENS_nearest.png', dpi=300)
plt.show()