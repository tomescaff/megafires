...
filename = 'MLE_tasmax_jan_RI_GMST_10_normal_validation.nc'
qn = xr.open_dataset(join(relpath, filename))

filename = 'MLE_tasmax_jan_LENS1_GMST_10_normal_validation_RI.nc'
...
plt.tight_layout()
plt.savefig('../../../megafires_data/png/RI_all_models_mle_validation.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()
