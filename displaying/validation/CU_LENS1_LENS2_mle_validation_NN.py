...
filename = 'MLE_tasmax_jan_CU_GMST_1000_normal_validation.nc'
...
filename = 'MLE_tasmax_jan_LENS2_GMST_100_normal_validation_CU_NN.nc'
...
plt.tight_layout()
plt.savefig('../../../megafires_data/png/CU_LENS1_LENS2_mle_validation_NN.png', dpi=300, bbox_inches = 'tight', pad_inches = 0)
plt.show()
