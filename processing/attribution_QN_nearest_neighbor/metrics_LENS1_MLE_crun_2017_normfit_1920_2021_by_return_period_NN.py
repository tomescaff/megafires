...
# counterfactual
cr = lens.get_LENS_jan_tmax_QNW_control_run()
...
# bootstrap MLE
nboot = 1000
filepath = '../../../megafires_data/output/MLE_tasmax_jan_LENS1_GMST_'+str(nboot)+'_normal_evaluation_QN_NN.nc'
...
df.to_csv(f'../../../megafires_data/output/metrics_LENS1_MLE_crun_{ac_year}_normfit_1920_2021_by_return_period_QN_NN.csv')