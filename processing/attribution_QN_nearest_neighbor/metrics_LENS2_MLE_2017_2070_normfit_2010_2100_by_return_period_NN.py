...
index = ['tau ac', 'tau fu', 'rr a-f', 'far a-f', 'delta f-a']
...
df.to_csv(f'../../../megafires_data/output/metrics_LENS2_MLE_{fu_year}_{ac_year}_normfit_2010_2100_by_return_period_QN_NN.csv')