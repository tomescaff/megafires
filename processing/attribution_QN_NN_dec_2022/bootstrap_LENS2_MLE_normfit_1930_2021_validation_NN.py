...
lens2_tmax_full = lens.get_LENS2_dec_tmax_QNW()
qn_full = stns.get_QN_tmax_dec_1911_2022()

qn = qn_full.sel(time=slice('1930', '2022'))
lens2_gmst = lens2_gmst_full.sel(time=slice('1930', '2022'))
lens2_tmax = lens2_tmax_full.sel(time=slice('1930', '2022'))
...
for i in range(nboot):
    ...
    xopt_i = pmath.mle_norm_2d_fast(qn_i, sm_i, [27.57, 1.15, 0.88])
...
filepath = '../../../megafires_data/output/MLE_tasmax_jan_LENS2_GMST_'+str(nboot)+'_normal_validation_QN_NN_dec_2022.nc'
