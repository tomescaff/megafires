...
lens2_gmst = lens2_gmst_full.sel(time=slice('1850', '2022'))
lens2_tmax = lens2_tmax_full.sel(time=slice('1850', '2022'))
...
# bootstrap MLE
nboot = 10
filepath = '../../../megafires_data/output/MLE_tasmax_jan_LENS2_GMST_'+str(nboot)+'_normal_evaluation_QN_NN_dec_2022.nc'
...
df.to_csv(f'../../../megafires_data/output/metrics_LENS2_MLE_{cf_year}_{ac_year}_normfit_1850_2022_by_return_period_QN_NN_dec_2022.csv')