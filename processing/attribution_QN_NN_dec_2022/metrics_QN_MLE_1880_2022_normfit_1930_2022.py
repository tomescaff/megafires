...
sm_no2022 = sm.where(sm.time.dt.year != 2022, drop=True)
qn_n02022 = qn.where(qn.time.dt.year != 2022, drop=True)

xopt = pmath.mle_norm_2d(qn_n02022.values, sm_no2022.values, [15, 2, 0.5])
...
df.to_csv(f'../../../megafires_data/output/metrics_QN_MLE_{cf_year}_{ac_year}_normfit_1930_2022_dec_2022.csv')