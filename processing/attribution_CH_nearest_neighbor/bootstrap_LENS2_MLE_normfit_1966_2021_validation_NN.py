...
lens2_gmst = lens2_gmst_full.sel(time=slice('1966', '2021'))
lens2_tmax = lens2_tmax_full.sel(time=slice('1966', '2021'))
...
filepath = '../../../megafires_data/output/MLE_tasmax_jan_LENS2_GMST_'+str(nboot)+'_normal_validation_CH_NN.nc'
