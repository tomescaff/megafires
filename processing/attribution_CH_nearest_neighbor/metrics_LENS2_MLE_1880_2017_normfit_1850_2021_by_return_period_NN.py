...
lens2_tmax_full = lens.get_LENS2_jan_tmax_CH_NN()
...
# bootstrap MLE
nboot = 1000
filepath = '../../../megafires_data/output/MLE_tasmax_jan_LENS2_GMST_'+str(nboot)+'_normal_evaluation_CH_NN.nc'
...
df.to_csv(f'../../../megafires_data/output/metrics_LENS2_MLE_{cf_year}_{ac_year}_normfit_1850_2021_by_return_period_CH_NN.csv')