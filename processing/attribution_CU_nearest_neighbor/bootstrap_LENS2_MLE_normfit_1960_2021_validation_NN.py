...
qn_full = stns.get_CU_tmax_jan()

qn = qn_full.sel(time=slice('1960', '2021'))
...
filepath = '../../../megafires_data/output/MLE_tasmax_jan_LENS2_GMST_'+str(nboot)+'_normal_validation_CU_NN.nc'
