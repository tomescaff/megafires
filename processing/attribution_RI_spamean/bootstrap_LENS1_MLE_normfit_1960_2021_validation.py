...
for i in range(nboot):
    ri_i, sm_i = bootstrap(lens1_tmax_arr, lens1_gmst_arr)
    xopt_i = pmath.mle_norm_2d_fast(ri_i, sm_i, [29.55, 1.03, 1.11])
...
filepath = '../../../megafires_data/output/MLE_tasmax_jan_LENS1_GMST_'+str(nboot)+'_normal_validation_RI.nc'
