...
qn_n02017 = ri.where(ri.time.dt.year != 2017, drop=True)
...
df.to_csv(f'../../../megafires_data/output/metrics_RI_MLE_{cf_year}_{ac_year}_normfit_1960_2021_nboot_{nboot}.csv')