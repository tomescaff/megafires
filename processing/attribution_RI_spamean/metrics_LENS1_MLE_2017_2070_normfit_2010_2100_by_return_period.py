...
# bootstrap MLE
nboot = 10
filepath = '../../../megafires_data/output/MLE_tasmax_jan_LENS1_GMST_'+str(nboot)+'_normal_future_RI.nc'
...
df.to_csv(f'../../../megafires_data/output/metrics_LENS1_MLE_{ac_year}_{fu_year}_normfit_2010_2100_by_return_period_RI_nboot_{nboot}.csv')