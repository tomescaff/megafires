...
ds = xr.open_dataset('../../../megafires_data/LENS_ALL/LENS_trefht_1979_2006_0_34_run_yearly.nc')
da = ds['TREFHT']
...
ds_out.to_netcdf('../../../megafires_data/LENS_ALL/LENS_trefht_1979_2006_yearly_trend.nc')
