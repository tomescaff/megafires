...
ds = xr.open_dataset('../../../megafires_data/LENS_ALL/LENS_trefht_mean_mon_1979_2006_0_34_run.nc')
da = ds['TREFHT']-273.15
da_seltime = da.sel(time=slice('1979', '2006'))
da_year = from_mon_to_year(da_seltime)
ds_out = xr.Dataset({'TREFHT':da_year})
ds_out.to_netcdf('../../../megafires_data/LENS_ALL/LENS_trefht_1979_2006_0_34_run_yearly.nc')
