...
ds = xr.open_dataset('../../../megafires_data/LENS_ALL/LENS_tmean_1979_2006_yearly.nc')
da = ds['TSA']
...
ds_out.to_netcdf('../../../megafires_data/LENS_ALL/LENS_tmean_1979_2006_yearly_trend.nc')
